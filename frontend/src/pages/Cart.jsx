    ...
    <>
      ...
      <section className="min-h-screen bg-black pt-[120px] px-6 lg:px-16 pb-20">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-white text-6xl font-black mt-4 leading-none">MY<br />CART</h1>
        </div>
        ...
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-[300px] gap-6">
            ...
            <h2 className="text-gray-400 text-2xl font-bold">Your cart is empty</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              {cart.map((product) => (
                <div
                  ...
                  className="bg-[#161616] rounded-[32px] overflow-hidden border border-white/10 flex hover:-translate-y-1 transition duration-300"
                >
                  {/* Image */}
                      ...
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.parentElement.innerHTML =
                            `<div class="w-full h-full flex items-center justify-center text-gray-600 text-xs font-bold">NO IMAGE</div>`;
                        }}
                      />
                    ) : (
                      <div className="w-full h-full flex items-center justify-center text-gray-600 text-xs font-bold">NO IMAGE</div>
                    )}
                  </div>
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-between">
                    <div>
                      ...
                      <h2 className="text-white text-2xl font-black mt-1">{product.name}</h2>
                      {/* ── SIZE shown as US ── */}
                    ...
                    <div className="flex items-center justify-between mt-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-white font-black text-lg w-6 text-center">{product.quantity}</span>
                        <button
            ...
            <div className="lg:col-span-1">
              <div className="bg-[#161616] rounded-[32px] border border-white/10 p-8 sticky top-[120px]">
                <h2 className="text-white text-2xl font-black mb-8 tracking-tight">ORDER SUMMARY</h2>
                ...
                {/* Size summary per item */}
                <div className="mb-6 flex flex-col gap-2">
                  {cart.map((p) => (
                    <div key={`${p.id}-${p.size}`} className="flex justify-between text-xs text-gray-500">
                      <span className="truncate max-w-[60%]">{p.name}</span>
                      <span className="text-white font-bold">US {p.size} × {p.quantity}</span>
                    </div>
                  ))}
                </div>
