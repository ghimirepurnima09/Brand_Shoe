      ...
      <section className="min-h-screen bg-black px-6 lg:px-16 pt-[120px] pb-20">
        ...
        <div className="mb-10 flex items-end justify-between">
          <div>
            ...
            <h1 className="text-white text-6xl font-black mt-4 leading-none">WOMEN<br />COLLECTION</h1>
          </div>
            ...
            <div className="w-[260px] min-w-[260px] flex flex-col gap-4">
              ...
              <div className="bg-[#161616] rounded-[24px] border border-white/10 overflow-hidden">
                <button onClick={() => setOpenBrand(!openBrand)} className="w-full flex items-center justify-between px-6 py-5 text-white font-black uppercase tracking-[2px] text-sm">
                  Brand
                  {openBrand ? <ChevronUp size={16} className="text-[#8da27f]" /> : <ChevronDown size={16} className="text-gray-500" />}
                </button>
                {openBrand && (
              ...
              <div className="bg-[#161616] rounded-[24px] border border-white/10 overflow-hidden">
                <button onClick={() => setOpenPrice(!openPrice)} className="w-full flex items-center justify-between px-6 py-5 text-white font-black uppercase tracking-[2px] text-sm">
                  Price Range
                  {openPrice ? <ChevronUp size={16} className="text-[#8da27f]" /> : <ChevronDown size={16} className="text-gray-500" />}
                </button>
                {openPrice && (
                  <div className="px-6 pb-6">
                    ...
                    <div className="flex flex-col gap-3">
                      <div>
                        ...
                        <input type="range" min={0} max={maxPrice} step={500} value={priceRange[0]}
                          onChange={(e) => { const v = Number(e.target.value); if (v < priceRange[1]) setPriceRange([v, priceRange[1]]); }}
                          className="w-full accent-[#8da27f] cursor-pointer" />
                      </div>
                      <div>
              ...
              <div className="bg-[#161616] rounded-[24px] border border-white/10 overflow-hidden">
                <button onClick={() => setOpenSize(!openSize)} className="w-full flex items-center justify-between px-6 py-5 text-white font-black uppercase tracking-[2px] text-sm">
                  Size (US)
                  {openSize ? <ChevronUp size={16} className="text-[#8da27f]" /> : <ChevronDown size={16} className="text-gray-500" />}
                </button>
                {openSize && (
              ...
              <p className="text-gray-500 text-xs uppercase tracking-[2px] text-center">
